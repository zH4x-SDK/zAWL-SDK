...
public:
	...
	{
		static UClass* ptr = UObject::FindClass("WidgetBlueprintGeneratedClass Z_InventoryCraftMainCard.Z_InventoryCraftMainCard_C");
		return ptr;
	}
	...
	void ExecuteUbergraph_Z_InventoryCraftMainCard();
};
