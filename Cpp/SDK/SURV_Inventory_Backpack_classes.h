...
// WidgetBlueprintGeneratedClass SURV_Inventory_Backpack.SURV_Inventory_Backpack_C
// 0x0000
...
public:
	...
	{
		static UClass* ptr = UObject::FindClass("WidgetBlueprintGeneratedClass SURV_Inventory_Backpack.SURV_Inventory_Backpack_C");
		return ptr;
	}
	...
	void SetSlotSize();
	void ExecuteUbergraph_SURV_Inventory_Backpack();
};
