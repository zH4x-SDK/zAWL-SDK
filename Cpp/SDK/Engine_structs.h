...
enum class Engine_EActorUpdateOverlapsMethod : uint8_t
{
...
enum class Engine_EPreviewAnimationBlueprintApplicationMethod : uint8_t
{
...
enum class Engine_EInertializationSpace : uint8_t
{
...
enum class Engine_EInertializationBoneState : uint8_t
{
...
enum class Engine_EInertializationState : uint8_t
{
...
enum class Engine_EAudioFaderCurve : uint8_t
{
...
enum class Engine_EAudioComponentPlayState : uint8_t
{
...
enum class Engine_EMatrixColumns : uint8_t
{
...
enum class Engine_ERuntimeVirtualTextureMipValueMode : uint8_t
{
	RVTMVM_None                    = 0,
	RVTMVM_MipLevel                = 1,
	RVTMVM_MipBias                 = 2,
...
enum class Engine_ERuntimeVirtualTextureDebugType : uint8_t
{
...
enum class Engine_ERayTracingGlobalIlluminationType : uint8_t
{
...
enum class Engine_EClothMassMode : uint8_t
{
...
enum class Engine_ESkeletalMeshSkinningImportVersions : uint8_t
{
...
enum class Engine_ESkeletalMeshGeoImportVersions : uint8_t
{
...
enum class Engine_ESoundWaveLoadingBehavior : uint8_t
{
